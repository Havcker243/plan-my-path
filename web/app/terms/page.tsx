...
export const metadata = {
  title: "Terms of Service — Fiskpath",
  description: "Read Fiskpath's Terms of Service to understand how you may use the platform.",
};
...
const sections = [
  {
    ...
    content:
      "By accessing or using Fiskpath, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using this service. We reserve the right to update these terms at any time, and your continued use of the service after changes are posted constitutes your acceptance of those changes.",
  },
  {
    number: "02",
    title: "Use of Service",
    content:
      "Fiskpath is an academic planning tool intended for personal, non-commercial use by students. You agree not to misuse the service, attempt to gain unauthorized access to any part of the platform, scrape or harvest data, or use Fiskpath in any way that could harm other users or the integrity of the platform. We reserve the right to suspend or permanently terminate accounts that violate these terms without prior notice.",
  },
  {
    number: "03",
    title: "User Accounts",
    content:
      "You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. You must provide accurate, current, and complete information when creating an account and update it promptly if anything changes. Notify us immediately at support@fiskpath.app if you suspect unauthorized use of your account. We are not liable for any loss resulting from unauthorized access caused by your failure to protect your credentials.",
  },
  {
    number: "04",
    title: "Intellectual Property",
    content:
      "All content, design, and functionality of Fiskpath — including but not limited to the software, text, graphics, and course data — is the exclusive property of Fiskpath and its licensors, protected by copyright, trademark, and other intellectual property laws. You are granted a limited, non-exclusive, non-transferable license to use the service for its intended purpose. You may not reproduce, distribute, modify, or create derivative works without our express written permission.",
  },
  {
    number: "05",
    title: "Disclaimer of Warranties",
    content:
      "Fiskpath is provided \"as is\" and \"as available\" without warranties of any kind, express or implied, including warranties of merchantability, fitness for a particular purpose, or non-infringement. We do not guarantee that the service will be uninterrupted, error-free, or that academic planning data will always be accurate, complete, or current. Course requirements, prerequisites, and graduation rules change over time. Always verify your degree requirements with your official academic advisor or institution registrar before making enrollment decisions.",
  },
  {
    number: "06",
    title: "Limitation of Liability",
    content:
      "To the fullest extent permitted by applicable law, Fiskpath and its officers, directors, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of — or inability to use — the service. This includes, without limitation, academic decisions made based on information provided by Fiskpath, loss of data, or loss of academic standing. Our total cumulative liability to you shall not exceed the greater of $100 USD or the amount you paid for the service in the twelve months preceding the claim.",
  },
  {
    number: "07",
    title: "Changes to Terms",
    content:
      "We may revise these Terms of Service from time to time to reflect changes in law, our practices, or the features we offer. We will notify registered users of material changes via email or an in-app notice at least 14 days before they take effect. If you disagree with the revised terms, you may close your account before the changes become effective. Your continued use of Fiskpath after the effective date constitutes acceptance of the updated terms.",
  },
  {
    number: "08",
    title: "Governing Law",
      ...
      <main className="max-w-2xl mx-auto px-6 py-14">
        ...
        <div className="flex items-start gap-4 mb-10 pb-10 border-b border-border">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-3 leading-relaxed max-w-lg">
              Please read these terms carefully before using Fiskpath. By using the service, you agree to be bound by them.
            </p>
          </div>
        </div>
            ...
            section.isContact ? (
              <section key={section.number}>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  <a
                    href="mailto:support@fiskpath.app"
                    className="text-primary hover:underline font-medium"
                  >
                    support@fiskpath.app
                  </a>
                  . We aim to respond to all inquiries within two business days. You can also reach us by mail at Fiskpath, Inc., United States.
                </p>
              </section>
            ) : (
              <section key={section.number}>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-xs text-muted-foreground">
            ...
            <a href="mailto:support@fiskpath.app" className="text-primary hover:underline">
              support@fiskpath.app
            </a>
            .
          </p>
