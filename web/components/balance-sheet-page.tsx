    ...
    return (
      <div className="px-4 md:px-8 py-6 max-w-5xl mx-auto pb-8">
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
            The next supported version will let the student choose between the Fiskpath template and an uploaded custom balance sheet.
          </p>
          <div className="mt-5">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
              {source === "system"
                ...
                : "Upload a PDF or image version of your own balance sheet to use it as the source instead of the Fiskpath template."}
            </p>
        ...
        <>
                      ...
                      >
                        <div className="min-w-0">
                          ...
                          <div className="flex flex-wrap gap-2 mt-2 pl-0 md:pl-6 print:hidden">
                            ...
                            <span className="rounded-full bg-green-50 px-2.5 py-0.5 text-[11px] text-green-700">
          ...
          <div className="hidden print:block mt-8 pt-4 border-t-2 border-black">
            ...
            <p className="text-[10px] text-center mt-3" style={{ color: "#888" }}>
              Generated by Fiskpath · {new Date().toLocaleDateString()}
            </p>
          </div>
        </>
      ) : (
            ...
            {customFile && customFileUrl ? (
              <div className="h-[70vh] print:h-auto bg-muted/20">
                {customFile.type === "application/pdf" ? (
                  ...
                  <div className="p-6 text-sm text-muted-foreground">
                    This file type is uploaded, but preview is not available in-page.
                  </div>
                )}
              </div>
            ) : (
              <div className="p-8 text-center">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Upload a PDF or image to use your own advisor balance sheet as the source.
                </p>
