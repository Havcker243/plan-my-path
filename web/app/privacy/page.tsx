...
export const metadata = {
  title: "Privacy Policy — FiskGrad",
  description: "Learn how FiskGrad collects, uses, and protects your personal information.",
};
...
const sections = [
  {
    ...
    content:
      "We collect information you provide directly when creating an account or using FiskGrad, including your name, email address, major, graduation year, GPA, and academic plan data. We also collect limited usage data — such as pages visited and features used — to improve the service. We do not collect sensitive personal data beyond what is necessary to operate FiskGrad, and we never collect financial information.",
  },
  {
    number: "02",
    title: "How We Use Your Information",
    content:
      "Your information is used solely to provide and personalize your FiskGrad experience: generating your academic plan, tracking degree progress, and sending account-related communications such as password resets. We do not sell your personal data to third parties or use it for targeted advertising. Aggregate, anonymized usage data may be used internally to improve features and course data quality.",
  },
  {
    number: "03",
      ...
      <main className="max-w-2xl mx-auto px-6 py-14">
            ...
            section.isContact ? (
              <section key={section.number}>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  <a
                    href="mailto:privacy@fiskgrad.app"
                    className="text-primary hover:underline font-medium"
                  >
                    privacy@fiskgrad.app
                  </a>
                  . We take privacy seriously and aim to respond to all inquiries within two business days. You can also reach us by mail at FiskGrad, Inc., United States.
                </p>
              </section>
            ) : (
              <section key={section.number}>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-xs text-muted-foreground">
            ...
            <a href="mailto:privacy@fiskgrad.app" className="text-primary hover:underline">
              privacy@fiskgrad.app
            </a>
            .
          </p>
